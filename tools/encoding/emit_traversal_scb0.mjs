...
const arrayBool = array(bool), arrayU32 = array(u32);
...
unaryTraversal(30, arrayBool, bool, [bool], bool, (out) => local(out, bool, 0));
tail(11, 10, 4, 4);

head("any", ["items"], [arrayBool], bool);
unaryTraversal(31, arrayBool, bool, [bool], bool, (out) => local(out, bool, 0));
tail(11, 10, 4, 4);

head("fold", ["items", "initial"], [arrayU32, u32], u32);
u32(w); w.u8(28); local(w, arrayU32, 1); local(w, u32, 0);
block([u32, u32], u32, (out) => local(out, u32, 1));
tail(12, 416, 4, 35);

head("mapArray", ["items"], [arrayU32], arrayU32);
unaryTraversal(32, arrayU32, arrayU32, [u32], u32, (out) => local(out, u32, 0));
tail(11, 320, 4, 131);

w.u32(0); w.u32(0); w.u32(0);
w.seq([0, 1, 2, 3], (value) => w.u32(value)); w.u32(0);
...
w.u32(0); w.u32(0); w.seq([0, 1, 2, 3], (value) => w.u32(value));

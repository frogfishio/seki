...
A0_SOURCES = src/alpha/sekic.c src/alpha/seki_lexer.c src/alpha/seki_parser.c src/alpha/seki_checker.c src/alpha/seki_core.c src/alpha/seki_c_backend.c

alpha: build/sekic

build/sekic: $(A0_SOURCES) src/alpha/seki_lexer.h src/alpha/seki_parser.h src/alpha/seki_checker.h src/alpha/seki_core.h src/alpha/seki_c_backend.h
	mkdir -p build

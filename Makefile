...
A0_SOURCES = src/alpha/sekic.c src/alpha/seki_lexer.c src/alpha/seki_parser.c src/alpha/seki_checker.c src/alpha/seki_core.c src/alpha/e0_backend_adapter.c

alpha: build/sekic

build/sekic: $(A0_SOURCES) src/alpha/e0_adapter.h src/alpha/seki_lexer.h src/alpha/seki_parser.h src/alpha/seki_checker.h src/alpha/seki_core.h src/e0/seki_e0_c_backend.c
	mkdir -p build
